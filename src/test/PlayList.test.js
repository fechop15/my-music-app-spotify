...
test('Render play list', () => {
    const playList = {
        ...
        "tracks": {
            "href": "https://api.spotify.com/v1/playlists/3cEYpjA9oz9GiPac4AsH4n/tracks?offset=0&limit=100&locale=es-ES,es;q=0.9,en;q=0.8,hu;q=0.7",
            "items": [
                {
                    ...
                    "track": {
                        ...
                        "name": "Api",
                        "popularity": 1,
                        "preview_url": "https://p.scdn.co/mp3-preview/c440fa9ff320fb74629f8477bff45b1a377897ab?cid=96bf8321208547a8834d4e73a5249853",
                        "track": true,
                        "track_number": 10,
                        "type": "track",
                ...
                },
                {
                    ...
                    "track": {
                        ...
                        "name": "All I Want",
                        "popularity": 43,
                        "preview_url": "https://p.scdn.co/mp3-preview/1dd960a5c02c5330a0d6578672971314d85adb75?cid=96bf8321208547a8834d4e73a5249853",
                        "track": true,
                        "track_number": 4,
                        "type": "track",
                ...
                },
                {
                    ...
                    "track": {
                        ...
                        "name": "Endpoints",
                        "popularity": 0,
                        "preview_url": "https://p.scdn.co/mp3-preview/c6366b5985c0c6200d065a1341bf2efc45693bcd?cid=96bf8321208547a8834d4e73a5249853",
                        "track": true,
                        "track_number": 2,
                        "type": "track",
    ...
    const component = render(<PlayList playList={playList}/>)
    component.getAllByText(playList.type)
    component.getAllByText(playList.name)
    component.getAllByText(playList.owner.display_name)
    component.getAllByText(playList.tracks.total+' canciones')
})